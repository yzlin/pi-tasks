...
Both task IDs and agent IDs (including partial prefixes) are accepted. Active agent IDs are resolved in memory. Settled agent IDs are resolved from task metadata.
